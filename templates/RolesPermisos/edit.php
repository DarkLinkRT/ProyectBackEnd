...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $coGroupsCoPermission->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $coGroupsCoPermission->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="coGroupsCoPermissions form content">
            ...
            <fieldset>
                <legend><?= __('Edit Co Groups Co Permission') ?></legend>
                <?php
