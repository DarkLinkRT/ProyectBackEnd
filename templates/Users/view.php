                                            ...
                                            <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                                <div class="media">
                                                    <a href="javascript: void(0);">
                                                        <img src="<?= $userData["hasPic"] ? $this->Url->Image('/files/userfiles/'.$userData["id"].'/picture/200.jpg') : $this->Url->Image('/files/default/defaultpic.jpg') ?>" alt="avatar" class="rounded mr-75" alt="profile image" height="64" width="64">
                                                    </a>
                                                ...
                                                <form novalidate>
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    ...
                                                                    <input type="text" class="form-control" id="account-username" placeholder="Username" value="<?= $userData["user"] ?>" required data-validation-required-message="This username field is required" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    ...
                                                                    <input type="text" class="form-control" id="account-name" placeholder="Name" value="<?= $userData["name"] ?>" required data-validation-required-message="This name field is required" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    ...
                                                                    <input type="text" class="form-control" id="account-name" placeholder="Name" value="<?= $userData["lastname"] ?>" required data-validation-required-message="This name field is required" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label for="account-e-mail">Rol</label>
                                                                    <input type="email" class="form-control" id="account-e-mail" placeholder="Email" value="<?= $userData["roleUser"] ?>" required data-validation-required-message="This email field is required" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- <div class="col-12">
                                                            <div class="alert alert-warning alert-dismissible mb-2" role="alert">
                                                                ...
                                                                <p class="mb-0">
                                                                    Tu correo no esta confirmado. Por favor verifica tu bandeja.
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="account-company">Compañía</label>
                                                                <input type="text" class="form-control" id="account-company" placeholder="Company name" value="Consultoría Integral SM2 Innovación" disabled>
                                                            </div>
                                                        </div>
