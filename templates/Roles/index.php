 ...
 * @var \App\Model\Entity\CoGroup[]|\Cake\Collection\CollectionInterface $coGroups
 */
?>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <p class="card-text">Administra los roles que aparecerán en el sistema.</p>
                            ...
                            <table class="table table-hover-animation">
                                ...
                                <tbody>
                                    <?php foreach ($coGroups as $coGroup): ?>
                                        <tr>
                                            <td> <i class="feather <?= $coGroup->icon ?> text-<?= $coGroup->color_icon ?>"></i> <?= $coGroup->name ?></td>
                                            <td>
                                                <?= $coGroup->active == 1 ? '<i class="fa fa-circle font-small-3 text-success mr-50"></i> Activo' : '<i class="fa fa-circle font-small-3 text-danger mr-50"></i> Inactivo' ?>
                                            </td>
                                            <td>
                                                <?= $coGroup->created ?>
                                            </td>
                                            <td>
                                                <?= $this->Html->link('<span class="action-edit"><i class="feather icon-edit"></i></span>', ['action' => 'edit', $coGroup->id],['escape'=>false]) ?>
                                                <?= $this->Html->link('<span class="action-edit"><i class="feather icon-trash"></i></span>', [ $coGroup->id],['escape'=>false,  'data-toggle'=>'modal', 'data-target' =>'#deletedata' . $coGroup->id]) ?>
                                            </td>
                                        </tr>
                                        <!-- Modal -->
                                        <div class="modal text-left" id="deletedata<?=  $coGroup->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel6" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <?= $this->Html->link('<button type="button" class="btn btn-primary">Aceptar</button>', ['action' => 'delete', $coGroup->id],['escape' => false]) ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
