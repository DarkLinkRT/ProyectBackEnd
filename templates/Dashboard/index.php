...
<?= $this->Html->css('/themes/vue/css/pages/page-profile.min.css') ?>
...
<div class="content-body">
    ...
    <div class="row">
        ...
        <div class="card profile-header mb-2">
            <!-- profile cover photo -->
            <img class="card-img-top" src="<?= $this->Url->Image('/files/default/banner.jpg') ?>" style="height:350px; object-fit: cover;" alt="User Profile Image">
            <!--/ profile cover photo -->
            ...
            <div class="profile-img-container d-flex align-items-center">
                ...
                <img src="<?= $userData["hasPic"] ? $this->Url->Image('/files/userfiles/'.$userData["id"].'/picture/200.jpg') : $this->Url->Image('/files/default/defaultpic.jpg') ?>" class="rounded img-fluid" alt="Card image" >
                </div>
                <!-- profile title -->
